...
import { useTemplateConfig } from "@src/services/template/templateConfigContes";
    ...
    >
      ...
      >
        <Image
          ...
          alt="Imagem de perfil do Shinoda Labs"
        />
  ...
  return (
    <Box>
      <Text variant="heading3" styleSheet={{
        marginBottom: "30px"
      }}>Ultimas Atualizações</Text>
      {posts.map(({ title, slug, image, metadata }) => {
        return (
          <FeedPost
            key={slug}
            title={title}
